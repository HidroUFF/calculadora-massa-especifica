...
class Ui_MainWindow(object):
    ...
    def getIndiceAtual(self) -> int:
            ...
            indice = 0
            for i in range(constant.NUM_SUBSTANCIAS):
    ...
    def retranslateUi(self, MainWindow) -> None:
        ...
        self.pushButton_idioma.setText(_translate("MainWindow", language))
